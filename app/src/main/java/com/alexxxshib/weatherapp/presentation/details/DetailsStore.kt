...
import com.alexxxshib.weatherapp.domain.usecase.ChangeFavouriteStateUseCase
import com.alexxxshib.weatherapp.domain.usecase.GetForecastUseCase
import com.alexxxshib.weatherapp.domain.usecase.ObserveFavouriteStateUseCase
import com.arkivanov.mvikotlin.core.store.Reducer
import com.arkivanov.mvikotlin.core.store.Store
import com.arkivanov.mvikotlin.core.store.StoreFactory
import com.arkivanov.mvikotlin.extensions.coroutines.CoroutineBootstrapper
import com.arkivanov.mvikotlin.extensions.coroutines.CoroutineExecutor
import com.alexxxshib.weatherapp.presentation.details.DetailsStore.Intent
import com.alexxxshib.weatherapp.presentation.details.DetailsStore.Label
import com.alexxxshib.weatherapp.presentation.details.DetailsStore.State
                ...
                Intent.ClickChangeFavouriteStatus -> {
                    scope.launch {
                        ...
                        if (state.isFavourite) {
                            changeFavouriteStateUseCase.removeFromFavourites(state.city.id)
                        } else {
                            changeFavouriteStateUseCase.addToFavourites(state.city)
                        }
                    }
                }
            }
