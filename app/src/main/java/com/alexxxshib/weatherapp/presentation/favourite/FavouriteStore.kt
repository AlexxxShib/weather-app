...
import com.alexxxshib.weatherapp.domain.usecase.GetCurrentWeatherUseCase
import com.alexxxshib.weatherapp.domain.usecase.GetFavouriteCitiesUseCase
import com.arkivanov.mvikotlin.core.store.Reducer
import com.arkivanov.mvikotlin.core.store.Store
import com.arkivanov.mvikotlin.core.store.StoreFactory
import com.arkivanov.mvikotlin.extensions.coroutines.CoroutineBootstrapper
import com.arkivanov.mvikotlin.extensions.coroutines.CoroutineExecutor
import com.alexxxshib.weatherapp.presentation.favourite.FavouriteStore.Intent
import com.alexxxshib.weatherapp.presentation.favourite.FavouriteStore.Label
import com.alexxxshib.weatherapp.presentation.favourite.FavouriteStore.State
...
class FavouriteStoreFactory @Inject constructor(
    ...
    private inner class ExecutorImpl : CoroutineExecutor<Intent, Action, State, Msg, Label>() {
        ...
        private suspend fun loadWeatherForCity(city: City) {
            ...
            try {
                val weather = getCurrentWeatherUseCase(city)
                dispatch(
                    Msg.WeatherLoaded(
                        cityId = city.id,
                        tempC = weather.tempC,
